...
namespace Core
{
    public class Lifetime
    {
        ...
        internal Lifetime()
        {
            ...
            var beh = new GameObject("Game.Lifetime").AddComponent<LifetimeBehaviour>();
        ...
        internal void FireLateUpdate()
        {
            OnLateUpdate.Fire();
        }

        internal void FireFixedUpdate()
        {
            OnFixedUpdate.Fire();
        }
        ...
        internal void FireResume()
        {
            OnResume.Fire();
        }

        internal void FireQuit()
        {
            OnQuit.Fire();
        }
    }
